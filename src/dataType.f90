module mod_data
    ...
    character(200) commts, climatefile, parafile, snowdepthfile   ! Jian: have the some row number with forcing
    logical, parameter :: do_snow    = .True.                     ! do soil physi
    ...
    real N_uptake,N_leach,N_vol,N_fixation,N_deposit
