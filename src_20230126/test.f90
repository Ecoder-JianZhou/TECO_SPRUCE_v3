...
! 1202  format(2(f15.4,","))
            ...
            do i=1,dtimes
                ...
                ! write(*,*)"test co2ca: ", co2ca, CO2treat
                ! co2ca=CO2treat*1.0E-6 ! CO2 concentration,ppm-->1.0E-6
                ...
                ! write(*,*)"input: ", input_data(:,m) 
                if (co2ca .lt. 0) co2ca=CO2treat*1.0E-6     
                ! Rnet=input_data(9,m)
...
160 continue
                ...
                call methane(Rh_pools,Tsoil,zwt,wsc,     &      !update single value in a hourly loop when MEMCMC=0
                    ...
                    ! if (gpp>0.) then  
                    !     write(*,*) "test gpp: ", gpp, yr, days, hoy, Acanop, doy!, Tair, Tsoil, RH, Dair, Rain, wind, PAR, co2ca
                    !     ! stop    
                    ! endif
                ! update NSC
...
subroutine canopy(gpp,evap,transp,Acanop,Hcanop,Rsoilabs, &  ! outputs
    ...
    !184   format(f15.9,",")
    !   ***  
    ! write(*,*)"test by Jian:", Acanop, Acan1, Acan2, coszen,doy,lat,pi,hour
    Acanop=Acan1+Acan2
    Ecanop=Ecan1+Ecan2
...
subroutine TCS_CN(Tair,Tsoil,omega,runoff,&
    ...
    ! write(*,*)"test S omega: ", S_w_min, omega
    ! *** ..int
    ! ***commented for CWE      
    do i=1,5
    ...
    ! write(*,*)"test_S_T_1: ", Q10h
    !     write(*,*)"test_S_T_2: ", tsoil_layer
    !     write(*,*)"test_S_T_3: ", frac_soc
    ...
    write(*,*)"test out C: ", QC(4), tauC(4), S_omega, S_t(1), CN(4), CN0(4)
    !========================================================================
    ! Nitrogen part
...
!184   format(14(f15.9,","))     
    ...
    !testout(1:10)=ice
    !testout(1)=Hsoil
    write(*,*)"test_testout: ", tsoill_0,sftmp, Tsoill(1), Tsnow, (Tsoill(1)+Tsnow)/2.
