...
160 continue        
            ...
            if (iforcing .eq. 1) i_record = 1; nday4out = 1
            if (ihour .eq. 23) then
                call summaryDaily(iTotDaily)
                nday4out = nday4out+1
                Simu_dailyflux14(1,i_record)  = GPP_d 
                Simu_dailyflux14(2,i_record)  = NEE_d                   
                Simu_dailyflux14(3,i_record)  = Reco_d	!Rh             
                Simu_dailyflux14(4,i_record)  = NPP_d!*1.5
                Simu_dailyflux14(5,i_record)  = Ra_d!*1.5
                ...
                Simu_dailyflux14_2023(1,i_record)  = GPP_d 
                Simu_dailyflux14_2023(2,i_record)  = NEE_d                   
                Simu_dailyflux14_2023(3,i_record)  = Reco_d	!Rh             
                Simu_dailyflux14_2023(4,i_record)  = NPP_d!*1.5
                Simu_dailyflux14_2023(5,i_record)  = Ra_d!*1.5
